export default {
    ...
    errors: {
        error404: 'Извините, но такой страницы не существует',
        common: 'Извините, что-то пошло не так',
    },
    links: {
        website: 'Сайт',
        source: 'Исходный код',
    ...
    actions: {
        ...
        showAll: 'Все',
        readPost: 'Читать...',
        toHomePage: 'Вернуться в начало',
    },
    about: {
        p1: 'Добрый день. Меня зовут Олег Кондраханов',
        p2: 'Я блокчейн/веб-разработчик',
        p3: 'Ознакомьтесь с моим портфолио и некоторыми статьями, прокрутив страницу ниже',
    },

    projects: {
        'bcshop.io': {
            short: 'Торговая площадка для цифровых товаров и услуг на базе блокчейна Ethereum.',
            long: [
        ...
        'justsmartcontracts.dev': {
            ...
            tech: [
                ...
                простое. Сперва фронт-энд был основан на чистом React + UI-компоненты Ant Design, однако.\
                позже я переписал его на Nextjs и Zustand. Информация о смарт-контрактах\
        ...
        'a2.legal': {
            short: 'MVP веб-приложения для юридической компании.',
            long: [
        ...
        't&d beauty': {
            ...
            long: [
                ...
                'Для меня это был один из наиболее интересных проектов из списка, в основном благодаря широкому\
        ...
        'portfolio': {
            displayName: 'Мое портфолио',
            short: 'Сайт-презентация моих работ',
            long:[
                'Вы сейчас его просматриваете :)',
            ],
            tech: [
                'Я использовал Nuxt в качестве генератора статичных сайтов. Русский/английский языки переключаются\
                 с помощью модуля nuxt-i18n.',
        ...
        'sensoriumxr': {
            ...
            long:[
                'Я работал в этой компании с середины 2020 года до конца 2021 года.',
                'В основном моей зоной ответственности были два вебсайта. \
        ...
        'decommas': {
            ...
            short: 'R&D отдел компании 3Commas (терминала для торговли криптовалютой)',
            long:[
                'Я работаю в DeCommas в должности Web3 тимлида с начала 2022 года.',
                'В этой роли я руковожу командой из 3-5 разработчиков, выполняя различные проекты в стиле стартапов.',
                'Основные проекты включают https://decommas.io/ - набор инструментов, связанных с DeFi,\
               и https://app.stier.trade/ - терминал для торговли мемкоинами'
            ],
            tech: [
                'Благодаря нескольким проектам мне посчастливилось использовать как \
                широко распространенные веб-технологии, такие как NestJS/NextJS, так и \
                узкоспециализированные, например, смарт-аккаунты от Alchemy или SDK от LiFi для обмена криптоактивами'
            ]
        }
    }
};
